...
| P-015 | Prep | preprocess-5 | formula | Cross-season rank normalization Z^J = Phi^-1(clip(1-(R^J-0.5)/N, 0.001, 0.999)) (Problem 3 only) |  | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
...
| P-061 | Problem 3 | 6_Success_Factors_Judges_vs_Fans.png | figure | Temporal evolution of judge/fan coefficient heatmap | visual | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
| P-062 | Problem 3 | eq:partner | formula | Partner traits H_abil = avg rank_past; H_exp = sum I(s in S_p) |  | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
| P-063 | Problem 3 | eq:fe_model | formula | Fixed effects: Z = mu + g1 H_abil + g2 H_exp + alpha_p + eps |  | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
| P-064 | Problem 3 | coef_tenure | metric | Partner tenure correlates with judge scores r=0.23, near-zero with fan votes | 0.23 | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
| P-065 | Problem 3 | 6_Partner_Traits_Correlation.png | figure | Partner trait correlation heatmap | visual | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
| P-066 | Problem 3 | 6_Pro_Partner_Historical_Impact.png | figure | Partner heterogeneity (raw ability vs fixed effects) | visual | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
| P-067 | Problem 3 | eq:surprise | formula | Surprise S = Z_Judge,t - Z_Fan,t-1; Growth G = Z_Fan,t - Z_Fan,t-1 |  | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
| P-068 | Problem 3 | eq:growth_model | formula | Quadratic interaction G = b0 + b1 S + b2 S^2 + b3 (S x H_exp) |  | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
| P-069 | Problem 3 | coef_surprise | metric | Surprise linear beta1=0.34 (p<0.001); beta2>0 (Matthew); beta3>0 (leverage) | 0.34 | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
| P-070 | Problem 3 | 6_Surprise_Effect_Vote_Growth.png | figure | Surprise -> vote growth linear response | visual | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
| P-071 | Problem 3 | 6_Surprise_NonLinearity_and_Interaction.png | figure | Surprise nonlinearity + tenure interaction | visual | ../src/dwts_pro_celeb_regression.py | problem3.regression | shared | planned |  | planned |
